...
# SECRET_KEY = 'django-insecure-9#pm_d0@&uw38+vt=ptt=tpc5tv$1*rz-a7zn&-^qo$1u7bo&l'
...
# Redis (manual result storage)
REDIS_URL = os.environ.get("REDIS_URL", "redis://localhost:6379/0")
REDIS_TTL_SECONDS = int(os.environ.get("REDIS_TTL_SECONDS", "600"))
